...
class AnalyserMod(AbstractMod):
    ...
    def tear_down(self, code, exception=None):
        ...
        return result_dict
#stock_position: avg_price,last_price,market_value,order_book_id,quantity,symbol
#stock_account: cash,dividend_will_receive,market_value,total_value,transaction_cost
#portfolio: cash,market_value,static_unit_net_value,total_value,unit_net_value,units
#trades: commission,exec_id,last_price,last_quantity,order_book_id,side,symbol,tax,trading_datetime,transaction_cost
#summary
